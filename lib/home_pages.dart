...
import 'package:shop_flutter/widgets/products_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Padding(
            padding: const EdgeInsets.only(top: 15, left: 19,right: 15,bottom: 0),
            child: Column(
              children: [
            // padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 0)
                ...
                //3 сверху, popular, иконка три точки первый экран
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  mainAxisSize: MainAxisSize.max,
